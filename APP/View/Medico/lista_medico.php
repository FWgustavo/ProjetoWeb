...
<head>
    ...
    <title>Clínica - Lista de Médicos</title>
    <style>
        * {
            margin: 0;
            padding: 0;
    ...
    <div class="main-content">
        ...
        <div class="content-area">
            <div class="header-actions">
                ...
                <a href="/medico/cadastro" class="btn-primary">➕ Novo Médico</a>
            </div>
            ...
            <div class="table-container">
                <?php if(count($model->rows) > 0): ?>
                    <table>
                        ...
                        <tbody>
                            <?php foreach($model->rows as $medico): ?>
                            <tr>
                                <td><?= $medico->Id ?></td>
                                <td>
                                ...
                                <td>
                                    <a href="/medico/cadastro?id=<?= $medico->Id ?>" class="action-link">✏️ Editar</a>
                                    <a href="/medico/delete?id=<?= $medico->Id ?>" 
                                       class="btn-delete"
                ...
                <?php else: ?>
                    <div class="empty-state">
                        ...
                        <p>Comece adicionando um novo médico ao sistema</p>
                    </div>
                <?php endif; ?>
            </div>
        </div>
