...
<div class="content">
    <div class="panel">
        ...
        <?= $model->getErrors() ?>
        <a href="/medico/cadastro" class="btn-main">Novo Médico</a>
        <table class="table mt-3">
            ...
            <tbody>
                ...
                <tr>
                    <td><?= $medico->Id ?></td>
                    <td><a href="/medico/cadastro?id=<?= $medico->Id ?>"><?= $medico->Nome ?></a></td>
                    <td><?= $medico->Crm ?></td>
                    <td><?= $medico->Especialidade ?></td>
                    <td><?= $medico->Telefone ?></td>
                    <td><?= $medico->Email ?></td>
                    <td>
                        <a href="/medico/delete?id=<?= $medico->Id ?>" class="btn-main">Remover</a>
                    </td>
                </tr>
                <?php endforeach ?>
            </tbody>
