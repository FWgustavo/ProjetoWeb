        ...
        <div class="content-area">
            <div class="form-container">
                <div class="form-header">
                    <h2><?= isset($model->Id) && $model->Id ? 'Editar Paciente' : 'Novo Paciente' ?></h2>
                </div>
                ...
                <form method="post" action="/paciente/cadastro">
                    ...
                    <div class="form-row">
                        <div class="form-group">
                            ...
                            <input 
                                ...
                                name="cpf" 
                                id="cpf" 
                                value="<?= htmlspecialchars($model->CPF ?? '') ?>"
                        ...
                        <div class="form-group">
                            ...
                            <input 
                                ...
                                id="data_nascimento" 
                                value="<?= htmlspecialchars($model->Data_Nascimento ?? '') ?>"
                            >
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <textarea 
                            name="endereco" 
                            id="endereco"
                        ><?= htmlspecialchars($model->Endereco ?? '') ?></textarea>
                    </div>
